...
- [1. Claude Behavior](#claude-behavior)
  ...
  - [1.6 Anthropic Reminders](#anthropic-reminders)
...
- [3. Persistent Storage for Artifacts](#persistent-storage-for-artifacts)
  - [3.1 Storage API](#storage-api)
  - [3.2 Usage Examples](#usage-examples)
  - [3.3 Key Design Pattern](#key-design-pattern)
  - [3.4 Data Scope](#data-scope)
  - [3.5 Error Handling](#error-handling)
  - [3.6 Limitations](#limitations)
- [4. MCP App Suggestions](#mcp-app-suggestions)
  - [4.1 Connector Directory First](#connector-directory-first)
  - [4.2 After Search](#after-search)
  - [4.3 Third-Party MCP App Tools Need Opt-In](#third-party-mcp-app-tools-need-opt-in)
  - [4.4 When to Call a Third-Party MCP App Tool Directly](#when-to-call-a-third-party-mcp-app-tool-directly)
  - [4.5 What Not to Do](#what-not-to-do)
  - [4.6 What This Should Feel Like](#what-this-should-feel-like)
- [5. Computer Use](#computer-use)
  - [5.1 Skills](#skills)
  - [5.2 File Creation Advice](#file-creation-advice)
  - [5.3 High-Level Computer Use Explanation](#high-level-computer-use-explanation)
  - [5.4 File Handling Rules](#file-handling-rules)
  - [5.5 Producing Outputs](#producing-outputs)
  - [5.6 Sharing Files](#sharing-files)
  - [5.7 Artifact Usage Criteria](#artifact-usage-criteria)
  - [5.8 Package Management](#package-management)
  - [5.9 Examples](#examples)
  - [5.10 Additional Skills Reminder](#additional-skills-reminder)
- [6. Search Instructions](#search-instructions)
  - [6.1 Core Search Behaviors](#core-search-behaviors)
  - [6.2 Search Usage Guidelines](#search-usage-guidelines)
  - [6.3 Critical Copyright Compliance](#critical-copyright-compliance)
  - [6.4 Search Examples](#search-examples)
  - [6.5 Harmful Content Safety](#harmful-content-safety)
  - [6.6 Critical Reminders](#critical-reminders)
- [7. Using Image Search Tool](#using-image-search-tool)
- [8. Tool Definitions](#tool-definitions)
  - [8.1 ask_user_input_v0](#ask_user_input_v0)
  - [8.2 bash_tool](#bash_tool)
  - [8.3 create_file](#create_file)
  - [8.4 fetch_sports_data](#fetch_sports_data)
  - [8.5 image_search](#image_search)
  - [8.6 message_compose_v1](#message_compose_v1)
  - [8.7 places_map_display_v0](#places_map_display_v0)
  - [8.8 places_search](#places_search)
  - [8.9 present_files](#present_files)
  - [8.10 recipe_display_v0](#recipe_display_v0)
  - [8.11 recommend_claude_apps](#recommend_claude_apps)
  - [8.12 search_mcp_registry](#search_mcp_registry)
  - [8.13 str_replace](#str_replace)
  - [8.14 suggest_connectors](#suggest_connectors)
  - [8.15 view](#view)
  - [8.16 weather_fetch](#weather_fetch)
  - [8.17 web_fetch](#web_fetch)
  - [8.18 web_search](#web_search)
- [9. Identity Preamble](#identity-preamble)
- [10. Anthropic API in Artifacts ("Claudeception")](#anthropic-api-in-artifacts-claudeception)
- [11. Citation Instructions](#citation-instructions)
- [12. User Context](#user-context)
- [13. Available Skills](#available-skills)
- [14. Network Configuration](#network-configuration)
- [15. Filesystem Configuration](#filesystem-configuration)
- [16. Thinking Mode](#thinking-mode)
...
<a id="lists-and-bullets"></a>
#### 1.4.1 Lists and Bullets
...
<a id="responding-to-mistakes-and-criticism"></a>
### 1.8 Responding to Mistakes and Criticism
...
<a id="key-design-pattern"></a>
### 3.3 Key Design Pattern
...
<a id="mcp-app-suggestions"></a>
## 4. MCP App Suggestions
...
<a id="connector-directory-first"></a>
### 4.1 Connector Directory First
...
<a id="third-party-mcp-app-tools-need-opt-in"></a>
### 4.3 Third-Party MCP App Tools Need Opt-In
...
<a id="when-to-call-a-third-party-mcp-app-tool-directly"></a>
### 4.4 When to Call a Third-Party MCP App Tool Directly
...
<a id="what-this-should-feel-like"></a>
### 4.6 What This Should Feel Like
...
<a id="file-creation-advice"></a>
### 5.2 File Creation Advice
...
<a id="high-level-computer-use-explanation"></a>
### 5.3 High-Level Computer Use Explanation
...
<a id="producing-outputs"></a>
### 5.5 Producing Outputs
...
<a id="artifact-usage-criteria"></a>
### 5.7 Artifact Usage Criteria
...
<a id="additional-skills-reminder"></a>
### 5.10 Additional Skills Reminder
...
<a id="core-search-behaviors"></a>
### 6.1 Core Search Behaviors
...
<a id="search-usage-guidelines"></a>
### 6.2 Search Usage Guidelines
...
<a id="critical-copyright-compliance"></a>
### 6.3 Critical Copyright Compliance
...
<a id="harmful-content-safety"></a>
### 6.5 Harmful Content Safety
...
<a id="using-image-search-tool"></a>
## 7. Using Image Search Tool
...
## 8. Tool Definitions (Full Descriptions and Parameter Schemas)
...
<a id="anthropic-api-in-artifacts-claudeception"></a>
## 10. Anthropic API in Artifacts ("Claudeception")
