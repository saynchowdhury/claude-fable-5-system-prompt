...
> **Note:** The text above is truncated to match what was pasted. For the complete unformatted raw system prompt (~1,580 lines), see [`raw-system-prompt.txt`](raw-system-prompt.txt).
